...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=claude-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsImNsYXVkZS1tY3AiXSwiZW52Ijp7IlBFVFNUT1JFX0FQSV9LRVkiOiJTZXQgeW91ciBQRVRTVE9SRV9BUElfS0VZIGhlcmUuIn19)
...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22claude-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22claude-mcp%22%5D%2C%22env%22%3A%7B%22PETSTORE_API_KEY%22%3A%22Set%20your%20PETSTORE_API_KEY%20here.%22%7D%7D)
...
```
claude mcp add --transport stdio claude_api --env PETSTORE_API_KEY="Your PETSTORE_API_KEY here." -- npx -y claude-mcp
```
